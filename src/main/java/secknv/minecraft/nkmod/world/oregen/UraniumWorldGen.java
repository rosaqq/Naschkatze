...
public class UraniumWorldGen implements IWorldGenerator{
	...
	private void runGenerator(WorldGenerator generator, World world, Random rand, int chunk_x, int chunk_z, int veinsPerChunk, int minHeight, int maxHeight){
	...
	@Override
	public void generate(Random random, int chunk_X, int chunk_Z, World world, IChunkProvider chunkGenerator,
