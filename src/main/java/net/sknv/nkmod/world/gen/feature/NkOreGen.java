...
public class NkOreGen {
    ...
    public static void setup() {
        ...
        // Surface ore layer
        URANINITE_ORE_SURFACE = register("uraninite_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, RegistrateHandler.URANINITE_ORE.get().getDefaultState(), 6))
        ...
        // Deep ore layer
        URANINITE_ORE_DEEP = register("uraninite_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, RegistrateHandler.URANINITE_ORE.get().getDefaultState(), 18))
                .withPlacement(Placement.DEPTH_AVERAGE.configure(new DepthAverageConfig(15, 5)))
                .square()
                .func_242731_b(1));
    }
